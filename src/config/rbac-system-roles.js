...
module.exports = {
  ...
  DEVELOPER_ROLE: {
    ...
    rules: [
      {
        apiGroups: [''],
        resources: ['microservices', 'applications', 'applicationTemplates', 'microserviceTemplates', 'services', 'natsAccounts', 'natsUsers', 'natsAccountRules', 'natsUserRules', 'catalog', 'registries', 'secrets', 'configMaps', 'volumeMounts', 'models', 'runtimeClasses', 'certificates', 'capabilities', 'serviceAccounts', 'controller', 'execSessions', 'logs'],
