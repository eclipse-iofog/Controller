...
ALTER TABLE "VolumeMappings" ADD COLUMN IF NOT EXISTS scope VARCHAR(16) NOT NULL DEFAULT 'private';
...
ALTER TABLE "ChangeTrackings" ADD COLUMN IF NOT EXISTS knowledge BOOLEAN DEFAULT false;
ALTER TABLE "ChangeTrackings" ADD COLUMN IF NOT EXISTS microservice_knowledge BOOLEAN DEFAULT false;

ALTER TABLE "Fogs" ADD COLUMN IF NOT EXISTS knowledge_status TEXT;
ALTER TABLE "Fogs" ADD COLUMN IF NOT EXISTS active_knowledge BIGINT DEFAULT 0;
ALTER TABLE "Fogs" ADD COLUMN IF NOT EXISTS knowledge_last_update BIGINT DEFAULT 0;

ALTER TABLE "Fogs" ADD COLUMN IF NOT EXISTS system_cpus BIGINT;
ALTER TABLE "Fogs" ADD COLUMN IF NOT EXISTS system_total_memory BIGINT;
ALTER TABLE "Fogs" ADD COLUMN IF NOT EXISTS system_total_disk BIGINT;
ALTER TABLE "Fogs" ADD COLUMN IF NOT EXISTS system_os TEXT;
ALTER TABLE "Fogs" ADD COLUMN IF NOT EXISTS system_os_version TEXT;
ALTER TABLE "Fogs" ADD COLUMN IF NOT EXISTS system_kernel_version TEXT;
