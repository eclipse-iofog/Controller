...
const Fabric = sequelize.define('iofabrics', {
  uuid: {type: Sequelize.TEXT, primaryKey: true, field: 'UUID'},
  name: {type: Sequelize.TEXT, defaultValue: "Unnamed ioFabric 1", field: 'Name'},
  ...
  daemonStatus: {type: Sequelize.TEXT, defaultValue: "UNKNOWN", field: 'DaemonStatus'},
  daemonOperatingDuration: {type: Sequelize.BIGINT, defaultValue: 0, field: 'DaemonOperatingDuration'},
  daemonLastStart: {type: Sequelize.BIGINT, field: 'DaemonLastStart'},
  memoryUsage: {type: Sequelize.FLOAT, defaultValue: 0.000, field: 'MemoryUsage'},
  diskUsage: {type: Sequelize.FLOAT, defaultValue: 0.000, field: 'DiskUsage'},
  cpuUsage: {type: Sequelize.FLOAT, defaultValue: 0.00, field: 'CPUUsage'},
  ...
  ipAddress: {type: Sequelize.TEXT, defaultValue: "0.0.0.0", field: 'IPAddress'},
  processedMessages: {type: Sequelize.BIGINT, defaultValue: 0, field: 'ProcessedMessages'},
  ...
  networkInterface: {type: Sequelize.TEXT, defaultValue: "eth0", field: 'NetworkInterface'},
  dockerURL: {type: Sequelize.TEXT, defaultValue:"unix:///var/run/docker.sock", field: 'DockerURL'},
  diskLimit: {type: Sequelize.FLOAT, defaultValue: 50, field: 'DiskLimit'},
  diskDirectory: {type: Sequelize.TEXT, field: 'DiskDirectory'},
  memoryLimit: {type: Sequelize.FLOAT, defaultValue: 4096 , field: 'MemoryLimit'},
  cpuLimit: {type: Sequelize.FLOAT, defaultValue: 80, field: 'CPULimit'},
  logLimit: {type: Sequelize.FLOAT, defaultValue: 10, field: 'LogLimit'},
  logDirectory: {type: Sequelize.TEXT, defaultValue: "/var/log/iofabric/", field: 'LogDirectory'},
  logFileCount: {type: Sequelize.BIGINT, defaultValue: 10, field: 'LogFileCount'},
