module.exports = {
  ...
  KNOWLEDGE_NOT_FOUND: 'Knowledge with name {} not found',
  KNOWLEDGE_ALREADY_EXISTS: 'Knowledge with name {} already exists',
  KNOWLEDGE_IN_USE: 'Cannot delete knowledge \'{}\': bound by microservices {}',
  KNOWLEDGE_UNLINK_IN_USE: 'Cannot unlink knowledge \'{}\' from agent {}: bound by microservices {}',
  KNOWLEDGE_OCI_FILES_FORBIDDEN: 'OCI knowledge must not specify files',
  ...
  MICROSERVICE_CATALOG_BIND_PATH_REQUIRES_ITEMS: 'Model catalog bindPath requires at least one item',
  ...
  MICROSERVICE_CATALOG_PATH_COLLISION: 'Model catalog path \'{}\' collides with a volume, tmpfs, or knowledge catalog mount',
  MICROSERVICE_CATALOG_MODEL_NOT_FOUND: 'Model catalog item \'{}\' does not match a fleet model',
  MICROSERVICE_KNOWLEDGE_BIND_PATH_REQUIRED: 'Knowledge catalog bindPath is required when items are present',
  MICROSERVICE_KNOWLEDGE_BIND_PATH_REQUIRES_ITEMS: 'Knowledge catalog bindPath requires at least one item',
  MICROSERVICE_KNOWLEDGE_BIND_PATH_ABSOLUTE: 'Knowledge catalog bindPath must be an absolute container path',
  MICROSERVICE_KNOWLEDGE_PERMISSIONS: 'Knowledge catalog permissions must be ro or rw',
  MICROSERVICE_KNOWLEDGE_DUPLICATE_ITEM: 'Knowledge catalog item name \'{}\' is duplicated',
  MICROSERVICE_KNOWLEDGE_ITEM_NAME: 'Knowledge catalog item name \'{}\' is invalid',
  MICROSERVICE_KNOWLEDGE_PATH_COLLISION: 'Knowledge catalog path \'{}\' collides with a volume, tmpfs, or model catalog mount',
  MICROSERVICE_KNOWLEDGE_NOT_FOUND: 'Knowledge catalog item \'{}\' does not match fleet knowledge',
  MICROSERVICE_KNOWLEDGE_SYSTEM_FORBIDDEN: 'System microservices cannot set a knowledge catalog',
